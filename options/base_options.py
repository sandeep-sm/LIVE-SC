...
class BaseOptions(object):
    ...
    def initialize(self, parser):
        # specify folder
        parser.add_argument('--data_folder', type=str, default='/scratch/08804/smishra/PNG_training_key_Frames',
                            help='path to data')
        parser.add_argument('--model_path', type=str, default='/scratch/08804/smishra/MOCO_VQA_experiments/exp4_IQA_20kvid_512dim_lr_0.1_epoch800',
                            help='path to save model')
        parser.add_argument('--tb_path', type=str, default='/scratch/08804/smishra/MOCO_VQA_experiments/exp4_IQA_20kvid_512dim_ßßlr_0.1_epoch800',
                            help='path to tensorboard')

        # parser.add_argument('--model_path', type=str, default='/scratch/08804/smishra/MOCO_VQA_experiments/exp1_lr_0.03_epoch400',
        #                     help='path to save model')
        # parser.add_argument('--tb_path', type=str, default='/scratch/08804/smishra/MOCO_VQA_experiments/exp1_lr_0.03_epoch400',
        #                     help='path to tensorboard')
        # basics
        ...
        parser.add_argument('--save_freq', type=int, default=1,
                            help='save frequency')
        parser.add_argument('--batch_size', type=int, default=357,
                            help='batch_size')
        ...
        parser.add_argument('--n_aug', type=int, default=5,
                            help='choices of distortion augementations')

        # model setup
        parser.add_argument('--arch', default='resnet50', type=str,
                            help='e.g., resnet50, resnext50, resnext101'
                                 'and their wider variants, resnet50x4')
        parser.add_argument('-d', '--feat_dim', default=512, type=int,
        ...
        # resume
        parser.add_argument('--resume', default='/scratch/08804/smishra/MOCO_VQA_experiments/exp4_IQA_20kvid_512dim_lr_0.1_epoch800/MoCov2_resnet50_RGB_Jig_False_moco_aug_B_mlp_0.2_cosine/ckpt_epoch_250.pth', type=str, metavar='PATH',
        ...
        parser.add_argument('--dist-url', default='tcp://129.114.41.1:23456', type=str,
