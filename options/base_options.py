...
class BaseOptions(object):
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--data_folder', type=str, default='./data',
                            help='path to data')
        parser.add_argument('--model_path', type=str, default='./train_4_2048_frame_batch30_lr5e-2_save',
                            help='path to save model')
        parser.add_argument('--tb_path', type=str, default='./train_4_2048_frame_batch30_lr5e-2_tb',
        ...
        parser.add_argument('--batch_size', type=int, default=8,
                            help='batch_size')
        parser.add_argument('-j', '--num_workers', type=int, default=32,
        ...
        parser.add_argument('--learning_rate', type=float, default=0.05,
                            help='learning rate')
        parser.add_argument('--lr_decay_epochs', type=str, default='70,130',
        ...
        parser.add_argument('-d', '--feat_dim', default=2048, type=int,
        ...
        # --dist-url tcp://129.114.41.25:36829
        # --dist-url tcp://129.114.41.26:35091
